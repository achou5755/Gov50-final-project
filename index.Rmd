...
INTRODUCTION
Does screen time affect the mental health of children? The rise of social media apps like Instagram, TikTok, and Snapchat in the 21st century prematurely exposes school-age children to unprecedented content. I hypothesize that the more time children spend on their screens, the worse their mental health. On their screens, youth are exposed to a variety of triggers, including breaking news about climate change or politics, posts from friends exploring the world, and media produced by content creators who exemplify beauty standards. These conduce feelings of despair, FOMO, or self-hatred. 
...
We can see from the table above that the intercept is around 0.02, which implies that—when all other variables are 0, i.e. when a given adolescent consistently does not spend any time on their screen on weekdays, only about 2 percent of these children will still require or seek mental health treatment. The slope is 0.045, which means that for every increased hour of screen time, approximately 4.5 percent more adolescents require or seek mental health treatment. Of the three age groups, this is the greatest slope, which suggests that the effects of screen time on mental health — if they are causal — are most severe for adolescents.
